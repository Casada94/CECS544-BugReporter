...
public class Constants {
    ...
    public static final String QUERY_PROGRAM_NAME = "name";
    public static final String QUERY_RELEASE = "release";
    ...
    public static final String GET_EMPLOYEE_ACCOUNTS = "SELECT * FROM ACCOUNTS WHERE AUTHORITY IN ('ADMIN','EMPLOYEE','MANAGER')";
    ...
    public static final String INSERT_PROGRAM = "INSERT INTO PROGRAMS(NAME,`RELEASE`,VERSION) VALUES(:name,:release,:version)";
    public static final String UPDATE_PROGRAM = "UPDATE PROGRAMS SET NAME=:name,`RELEASE`=:release,VERSION=:version WHERE ID=:programId";
    public static final String DELETE_PROGRAM = "DELETE FROM PROGRAMS WHERE ID=:programId";
    public static final String GET_LAST_PROGRAM_ID = "SELECT MAX(ID) FROM PROGRAMS";
    public static final String INSERT_FUNCTIONAL_AREA = "INSERT IGNORE INTO FUNCTIONAL_AREA(AREA) VALUES(:functionalArea)";
    public static final String INSERT_PROGRAM_FUNCTIONAL_AREA = "INSERT IGNORE INTO FUNCTIONAL_AREA_MAPPING(PROGRAM_ID,FUNCTIONAL_AREA) VALUES(:programId,:functionalArea)";
    public static final String GET_PROGRAMS_AND_FUNCTIONS = "SELECT ID,NAME,`RELEASE`,VERSION,AREA FROM PROGRAMS\n" +
